...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
                ...
                <div class="sl-slider">
                    ...
                    <div class="sl-slide item1" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
                        <div class="sl-slide-inner">
                            <div class="container">
                                <img class="pull-right" src="templates/nova/images/sample/slider/img1.png" alt="" />
                    ...
                    <div class="sl-slide item2" data-orientation="vertical" data-slice1-rotation="10" data-slice2-rotation="-15" data-slice1-scale="1.5" data-slice2-scale="1.5">
                        <div class="sl-slide-inner">
                            <div class="container">
                                <img class="pull-right" src="templates/nova/images/sample/slider/img2.png" alt="" />
                    ...
                    <div class="sl-slide item3" data-orientation="horizontal" data-slice1-rotation="3" data-slice2-rotation="3" data-slice1-scale="2" data-slice2-scale="1">
                        <div class="sl-slide-inner">
                            <div class="container">
                                <img class="pull-right" src="templates/nova/images/sample/slider/img3.png" alt="" />
        ...
        <section class="main-info">            
            <div class="container">
                @yield('landing_insurance_mini_form');
            </div>
        </section>
        ...
        <section id="services">
            <div class="container">
                <div class="center gap">
                    <h3>What We Offer</h3>
                    <p class="lead">Look at the services we provide for our valuable clients</p>
                </div>
                ...
                <div class="row-fluid">
                    <div class="span4">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <h4 class="media-heading">Auto Insurance</h4>
                    ...
                    <div class="span4">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <h4 class="media-heading">Home Insurance</h4>
                                <p>Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.</p>
                            </div>
                        </div>
                    </div>            
                    ...
                    <div class="span4">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <h4 class="media-heading">Renters Insurance</h4>
                                <p>Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row-fluid">
                    <div class="span4">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <h4 class="media-heading">Business Insurance</h4>
                                <p>Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.</p>
                            </div>
                        </div>
                    </div>            
                    ...
                    <div class="span4">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <h4 class="media-heading">Life Insurance</h4>
                                <p>Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.</p>
                            </div>
                        </div>
                    </div>            
                    ...
                    <div class="span4">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <h4 class="media-heading">Health Insurance</h4>
                                <p>Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="myCarousel" class="carousel slide clients">
                            ...
                            <div class="carousel-inner">
                                <div class="active item">
                                    <div class="row-fluid">
                                        <ul class="thumbnails">
                                            <li class="span3"><a href="#"><img src="templates/nova/images/sample/clients/client1.png"></a></li>
                                            <li class="span3"><a href="#"><img src="templates/nova/images/sample/clients/client2.png"></a></li>
                                            <li class="span3"><a href="#"><img src="templates/nova/images/sample/clients/client3.png"></a></li>
                                            <li class="span3"><a href="#"><img src="templates/nova/images/sample/clients/client4.png"></a></li>
                                        </ul>
                                    </div>
                                </div>
...
<!--                    <div class="span3">
        ...
        <footer id="footer">
            <div class="container">
                <div class="row-fluid">
                    <div class="span5 cp">
                        &copy; 2013 <a target="_blank" href="/" title="Free Twitter Bootstrap WordPress Themes and HTML templates">Nirvana Insurance & Co.</a>. All Rights Reserved.
                    </div>
                    <!--/Copyright-->
            ...
            <div class="modal-body">                
                <!--                <form class="form-inline" role="form">
                                    <div class="form-group">
                                        <label class="control-label" for="email">Select Service:</label>
                                        <select class="dropdown pull-right">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label" for="pwd">ZIP Code:</label>
                                        <input type="text" class="form-control pull-right" name="zipcode" placeholder="Enter ZIP Code">
                                    </div>
                                    <div class="form-group">
                                        <label class="sr-only" for="pwd">Are you insured for last 6 months ?:</label>
                                        <input type="radio" class="form-control" name="insured" value="YES" />
                                        <input type="radio" class="form-control" name="insured" value="NO" />
                                    </div>
                                    <button type="submit" class="btn btn-default">GET QUOTES NOW!</button>
                                </form> -->
            </div>
            <!--/Modal Body-->
        </div>
        ...
        <script src="templates/nova/js/vendor/jquery-1.9.1.min.js"></script>
        <script src="templates/nova/js/vendor/bootstrap.min.js"></script>
        <script src="templates/nova/js/main.js"></script>
        <!-- Required javascript files for Slider -->
        <script src="templates/nova/js/jquery.ba-cond.min.js"></script>
        <script src="templates/nova/js/jquery.slitslider.js"></script>
        <!-- /Required javascript files for Slider -->
