(function ($, window, document, undefined) {
    ...
    try {
        $('#select_vehicle_year').select2();
        $('#select_vehicle_make').select2();
        $('#select_vehicle_model').select2();
        $('#select_current_insurance_company').select2();
        $('#select_vehicle_ownership_status').select2();
        $('#select_vehicle_primary_use').select2();
        $('#liability_coverage_level').select2();
        $('#select_collision_deductible').select2();
        $('#select_comprehensive_deductible').select2();
        $('#select_driver_gender').select2();
        $('#select_drive_martial_status').select2();
        $('#select_driver_credit_card_rating').select2();
        $('#select_driver_residence_status').select2();
        $('#driver_state_of_license').select2();
    ...
    try {
        $('#select_property_type').select2();
        $('#year_built').select2();
        $('#property_state').select2();
        $('#construction_type').select2();
        $('#foundation').select2();
        $('#roof_type').select2();
        $('#primary_heating_system').select2();
        $('#bed_rooms').select2();
        $('#bath_rooms').select2();
        $('#no_of_stories').select2();
    }
    catch (err) {

    }
    $('#contact_gender').select2();


    try {
        $('#date_of_policy_expiration').datepicker();
    }
    catch (err) {
    }
    try {
